...
![IsomorphicLocation.jpg](./images/IsomorphicLocation.jpg)

4. Follow the below installation instruction guideline

## Installing Packages & Dependencies:
Now open the `Isomorphic` app in your terminal. Now at your terminal In the root directory of `Isomorphic` app just run

```
yarn
```

![YarnRun.jpg](./images/YarnRun.jpg)
...
![OutputCra.png](./images/OutputCra.png)
