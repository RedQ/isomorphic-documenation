...
We are using the Auth0 [Lock](https://auth0.com/lock) widget.

In the folder path `/src/helpers/auth0/` there is a Auth0Helper class that uses all the functions.

To Use the Auth0 Api you need to configure your app to the Auth0-Official documentation first. And put your app credentials to the config file of our app.
